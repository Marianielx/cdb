    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        <ul class="navbar-nav flex-row align-items-center ms-auto">
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow notification" href="javascript:void(0);"
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        @foreach ($data_internship as $item)
                            <div class="dropdown-divider"></div>
                            <ul>
                                <small>
                                    <a href="{{ url("admin/internship/show/{$item->id}") }}">
                                        <p>{{ $item->name[0] }}</p>
                                    </a>
                                </small>
                            </ul>
                        @endforeach
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ route('admin.internship.create') }}">
                            <small>
