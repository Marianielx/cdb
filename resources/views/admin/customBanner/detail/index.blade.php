                                        ...
                                        <div class="col-12 col-lg-10">
                                            ...
                                            <div class="card-deck mb-4">
                                                <div class="card border-0 bg-transparent text-center">
                                                    <div class="card-img-top img-fluid rounded" style='background-image:url("/storage/{{ $data->image }}");background-position:center;background-size:cover;height:600px;width:auto;'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-auto pr-0">
                                                <div class="dropdown">
                                                    ...
                                                    <!-- <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{ url("admin/imageGallery/delete/{$item->id}") }}"><i class="bx bx-trash me-1"></i> {{ $count++ }} -
                                                            Excluir</a>
                                                    </div> -->
                                                </div>
                                            </div>
