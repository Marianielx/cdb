...
@section('title', 'Portal Central Da Banda - Listar Cliente')
                                ...
                                <table class="table datatables table-hover table-bordered" id="dataTable-1">
                                    ...
                                    <tbody class="bg-white">
                                        ...
                                        <tr class="text-center text-dark">
                                            ...
                                            <td>
                                                <a href="{{ url("admin/custom/detail/{$item->id}") }}"><i class='bx bx-slideshow' data-toggle="tooltip" data-placement="top" title="Anuncie aqui..."></i></a>
                                            </td>
                                            <td>
                                                <div class="dropdown">
